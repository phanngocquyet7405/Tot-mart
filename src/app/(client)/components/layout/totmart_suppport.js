      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16">
            <p className="text-xs tracking-[0.3em] text-green-600 mb-4 uppercase font-bold">
              Hỗ trợ khách hàng
            </p>
            <h2 className="text-3xl lg:text-4xl text-[#15202B] font-serif">
              Câu Hỏi Thường Gặp
            </h2>
          </div>
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="py-2">
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-5 h-5 text-green-600 transition-transform ${openFaqIndex === index ? "rotate-180" : ""}`}
                  />
                </button>
                <div
        ...
        <div className="border-b border-white/10 w-full">
          <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-center gap-6">
            <h3 className="font-bold text-base md:text-lg text-center md:text-left">
              Đăng ký nhận bản tin và nhận ưu đãi giảm giá cho đơn hàng đầu
              tiên.
            </h3>
            <form
